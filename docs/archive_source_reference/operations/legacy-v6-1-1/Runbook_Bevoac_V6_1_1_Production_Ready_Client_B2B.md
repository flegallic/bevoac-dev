...
**Version**: V6.1.1 - API 6.1.2-production-ready / Worker v6.1.1
...
| --- | --- | --- |
| Version | API/worker 5.3.0-production-acceptance | API 6.1.2-production-ready, worker image v6.1.1. |
...
| --- | --- | --- |
| API version | 6.1.2-production-ready | Titre, build et validations. |
