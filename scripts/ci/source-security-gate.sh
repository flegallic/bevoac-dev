...
grep -q "!var.deploy_onboarding_frontend" bevoac-iac-enterprise/v620-controlled-production.tf || fail "controlled production must forbid the legacy static onboarding frontend"
